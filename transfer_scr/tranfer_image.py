...
load_model.load_weights('./transfer_model_file/transfer_weights.h5')
...
path = "/home/vanlong/vanlong/ky6/doAn/tranfer_learning_model/long1.jpg"
path1 = "/home/vanlong/vanlong/ky6/doAn/tranfer_learning_model/591.jpg"
    ...
    for person in faces:
        ...
        if im_crop.shape[0] > 0 and im_crop.shape[1] > 0:
            ...
            if prediction[max_index] > 0.5:
                print(index_to_labes[max_index])
